...
parameters {
 ...
 matrix<lower=0, upper=1>[NAgeG, NGroup] sero;
...
generated quantities {
  ...
  vector[NGroup] sero_grp; // seroprevalence per stratum (age-weighted)
  real sero_all;           // overall seroprevalence across all strata and age groups
  vector[predL] fitNeg;
  vector[predL] fitPos;
  vector[predL] fitAll;
